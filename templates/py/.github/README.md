...
5. Installs and runs pytest tests (if available)
6. Builds the application with `python setup.py build`
7. Runs semantic-release for automatic versioning
...
### Option 5: Use Cloud Build for Custom Deployments

1. Create a `cloudbuild.yaml` in your project root
2. Push to your repository
3. Go to [Cloud Build](https://console.cloud.google.com/cloud-build)
4. Connect your GitHub repository
5. Create a trigger that builds and deploys on push
...
- [Cloud Profiler](https://console.cloud.google.com/profiler) for application profiling
